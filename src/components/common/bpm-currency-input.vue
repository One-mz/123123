<template>
  <x-input type="tel" ref="numeric" :value="amount" @on-blur="onBlurHandler" @on-change="onChangeHandler"
    @on-focus="onFocusHandler" @input="onInput" :title="title" text-align="right" :readonly="readonly"
...
<script type="text/javascript">
  ...
  export default {
    ...
    watch: {
      ...
      valueNumber(newValue) {
        if (this.$refs.numeric !== document.activeElement) {
          console.log('valueNumber,changeing detected')
    ...
    methods: {
       ...
       */
      onBlurHandler(e) {
        // console.log('onBlur valueNumber', this.valueNumber);
        // console.log('onBlur amount', this.amount);
        this.$emit('on-blur', this.amountNumber)
        //if(this.isIE || this.isEdge ) {
        // IE浏览器，js设置千分位后，无法触发change事件，手动触发
        console.log('onBlur onChange amountNumber', this.amountNumber);
       ...
       */
      onChangeHandler() {
        // console.log('changing', this.amountNumber);
        // console.log('valueNumber', this.valueNumber)
        // console.log('amount', this.amount)
        // if(!this.isIE && !this.isEdge) {
        //   console.log('onChange amountNumber', this.amountNumber);
        //   this.process(this.amountNumber)
        // }
      },
      onInput(value) {
        ...
        // 在 onChange 时记录光标的位置
        // console.log('this.inputDom.selectionStart', this.inputDom.selectionStart)
